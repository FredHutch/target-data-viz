...
RUN R -q -e 'BiocManager::install(c("ComplexHeatmap", "biomaRt", "GenomicRanges"), ask=FALSE, update=FALSE)'
...
RUN R -f /tmp/check.R --args shinyalert shinydashboard shinyjs shinyBS shinyWidgets shinythemes survminer gtools cmprsk ggpubr DT data.table viridis viridisLite ggplot2 plotly fst BiocManager dplyr ComplexHeatmap survival ggsurvfit openxlsx biomaRt GenomicRanges
